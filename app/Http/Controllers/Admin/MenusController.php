...
class MenusController extends AdminController
{
    ...
    public function create()
    {
        ...
        $list = [];
        $list = Arr::add($list,'0','Не использутеся');
        ...
        $articles = $articles->reduce(
            function ($returnArticles, $article) {
        ...
        $filters = Filter::select('id', 'title', 'alias')->get()->reduce(
            function ($returnFilters, $filter) {
        ...
        $portfolios = $this->p_rep->get(['id', 'alias', 'title'])->reduce(
            function ($returnPortfolios, $portfolio) {
