<div id="content-page" class="content group">
    <div class="hentry group">
        ...
        {!! Form::open(['action' => (isset($menu->id)) ? ['Admin\MenusController@update', $menu->id] : ['Admin\MenusController@store'],'class'=>'contact-form','method'=>'POST','enctype'=>'multipart/form-data']) !!}
...
<script>
    jQuery(function ($) {
        ...
        //     $('#accordion .radioMenu').first().attr('checked','checked');
        // }
