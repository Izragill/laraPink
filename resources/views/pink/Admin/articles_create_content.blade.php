...
{{--        @if(isset($article->id))--}}
{{--            {{ $url = 'Admin\ArticlesController@update', $id = $article->alias }}--}}
{{--        @else--}}
{{--            {{ $url = 'Admin\ArticlesController@store' }}--}}
{{--        @endif--}}

        {!! Form::open(['action' => isset($article->id) ? ['Admin\ArticlesController@update', $id = $article->alias] : ['Admin\ArticlesController@store'],
