<div id="content-page" class="content group">
    <div class="hentry group">
        ...
        {!! Form::open(['action' => (isset($user->id)) ? ['Admin\UsersController@update', $user->id] : ['Admin\UsersController@store'],'class'=>'contact-form','method'=>'POST','enctype'=>'multipart/form-data']) !!}
